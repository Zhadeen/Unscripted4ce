    ...
    <div ref={containerRef} className="min-h-screen pt-32 pb-32 relative overflow-hidden" style={{ background: "#050505" }}>
      ...
      <div className="mx-auto max-w-4xl px-6 lg:px-8 relative z-10 flex flex-col gap-16 md:gap-24">
        ...
        <div className="mb-8 mt-12 md:mt-24">
          ...
          <h1 className="text-4xl font-black leading-[0.95] tracking-tight uppercase sm:text-6xl md:text-7xl lg:text-[7.5rem]" style={{ fontFamily: "var(--font-display)" }}>
            <div className="overflow-hidden h-auto py-1"><span className="reveal-text inline-block">Unscripted</span></div>
            <div className="overflow-hidden h-auto py-1"><span className="reveal-text inline-block text-accent">Designs.</span></div>
          </h1>
        </div>
        ...
        <div className="flex flex-col gap-16 md:gap-20">
          <div className="about-block">
            <h2 className="text-xl font-black uppercase tracking-tight md:text-2xl text-text mb-6 flex items-center gap-4" style={{ fontFamily: "var(--font-heading)" }}>
          ...
          <div className="about-block">
            <h2 className="text-xl font-black uppercase tracking-tight md:text-2xl text-text mb-6" style={{ fontFamily: "var(--font-heading)" }}>
              What We Do
            </h2>
