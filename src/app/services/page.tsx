    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10 flex flex-col gap-16 md:gap-24">
        ...
        <div className="mt-12 md:mt-24 max-w-4xl">
          ...
          <h1 className="text-4xl font-black leading-[0.95] tracking-tight uppercase sm:text-6xl md:text-7xl lg:text-[7.5rem] mb-12 text-white opacity-100" style={{ fontFamily: "var(--font-display)" }}>
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 flex flex-col h-full">
                  ...
                  <h3 className="mb-4 text-xl font-black md:text-2xl opacity-100 tracking-tight" style={{ fontFamily: "var(--font-heading)", color: "#FFFFFF" }}>
                    {service.title}
                  </h3>
